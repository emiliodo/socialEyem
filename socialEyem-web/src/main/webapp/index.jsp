<%@page import="com.eyem.google.auth.GoogleAuthHelper"%>
	...
	<div class="oauthDemo">
		<%
			...
			if (request.getParameter("code") == null
				 ...
				 */
                                String googledata = helper.getUserInfoJson(request.getParameter("code"));
				out.println(googledata);
                                
                                session.setAttribute("googleAccountData", googledata);
				out.println("</pre>");
			}
		%>
	</div>
